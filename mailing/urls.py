...
from .views import (HomePageView, MailingAttemptDetailView,
                    MailingAttemptListView, MailingBlockView,
                    MailingCreateView, MailingDeleteView, MailingDetailView,
                    MailingListView, MailingSendView, MailingUpdateView,
                    MessageCreateView, MessageDeleteView, MessageDetailView,
                    MessageListView, MessageUpdateView, ReceiverCreateView,
                    ReceiverDeleteView, ReceiverDetailView, ReceiverListView,
                    ReceiverUpdateView, StatisticView)
